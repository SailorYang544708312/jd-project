...
<body ng-app="jd" ng-controller="itemController" ng-init="loadDefaultSku()">
<#--将图片字符串转换成json对象-->
			...
			<div class="fl preview-wrap">
				...
				<div class="zoom">
					...
					<div id="preview" class="spec-preview">
						<#if (imageList?size > 0)>
							<span class="jqzoom"><img jqimg="${imageList[0].url}" src="${imageList[0].url}" width="400" /></span>
						</#if>
						...
						<#list specificationList as specification>
							<dl>
								...
								<#list specification.attributeValue as item>
									<dd><a href="javascript:;" class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}" ng-click="selectSpecificaiton('${specification.attributeName}','${item}')">${item}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
